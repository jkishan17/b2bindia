...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('/storage/images/userProfile/'.Auth::getUser()->avatar) }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="{{ route('settings') }}" class="d-block">{{ Auth::getUser()->name }}</a>
                    </div>
                </div>
            ...
            <div class="sidebar-custom">
                <a href="{{ route('settings') }}" class="btn btn-link text-white" data-toggle="tooltip" title="Settings"><i class="fas fa-cogs"></i></a>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; {{ now()->year }} <a href="https://adminlte.io">AdminLTE.io</a>.</strong> All rights
            reserved.
        </footer>

        ...
        <div class="row mb-2 flash-message">
            ...
            <div class="col-sm-4">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('list.module') }}">Modules</a></li>
        ...
        <div class="row">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm @error('pname') is-invalid @enderror" id="pname"
                                    name="pname" placeholder="Enter Module Name" value="{{$emodule->name}}">
                                @if ($errors->has('pname'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm @error('slug') is-invalid @enderror" id="slug"
                                    name="slug" placeholder="Enter Slug Name" value="{{$emodule->slug}}">
                                @if ($errors->has('slug'))
            ...
            <div class="col-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover" id="PermissionDataTable">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Module</th>
